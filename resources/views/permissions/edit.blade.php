                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('permission.update',$permission->id)}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{old('name',$permission->name)}}" name="name" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg text-dark" placeholder="enter name"        style="color: black;"
                                >
                                @error('name')
